const Images = {
  background: {
    ...
    mask_gradient: require('@/assets/images/mask_gradient.png'),
    ...
    search_doctor: require('@/assets/images/search_doctor.png'),
  },
  button: {
  ...
  logo: {
    ...
    mark: require('@/assets/images/logo_mark.png'),
    title: require('@/assets/images/logo_title.png'),
