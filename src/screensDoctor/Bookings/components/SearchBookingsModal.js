...
import SearchBookingsModalMethods from './SearchBookingsModalMethods';
...
const SearchBookingsModal = (props) => {
  const vm = SearchBookingsModalMethods(props);
...
export default observer(SearchBookingsModal);
